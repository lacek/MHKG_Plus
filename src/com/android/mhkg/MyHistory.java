...
public class MyHistory extends Activity implements TableInfo {  
	 ...
	 private void showList() {   
	     SQLiteDatabase db = hisHelper.getReadableDatabase(); 
         Cursor cursor = db.query(TABLE2_NAME, FROM, null, null, null, null, ORDER_BY);  
    	 ...
    	 list.setOnItemClickListener(new OnItemClickListener() {
    		 public void onItemClick(AdapterView<?> a, View v, int position, long id) {
    			...
    			String hisURL = cursor.getString(cursor.getColumnIndexOrThrow(URL));
    			android.content.ClipboardManager clipboard = (android.content.ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE); 
    		    android.content.ClipData clip = android.content.ClipData.newPlainText("My History URL", hisURL);
